...
const PARTS = {
  ...
  cpu: [
    ...
    { id: 'cpu-i9-14900k', name: 'Intel Core i9-14900K',    price: 549, socket: 'LGA1700', mem: ['DDR4','DDR5'], memSpeed: 5600, cores: 24, pcore: 8, ecore: 16, threads: 32, base: 3.2, boost: 6.0, l3: 36, arch: 'Raptor Lake Refresh', tdp: 253, tdpRated: 125, igpu: true, igpuName: 'Intel UHD 770', cooler_inc: false, spec: '8P+16E / 32T · 6.0GHz boost · iGPU', img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Intel_i9-14900K.webp?width=600' },
  ...
  ram: [
    { id: 'ram-ddr5-16-6000', name: 'Corsair Vengeance 16GB DDR5-6000', price: 109, mem: 'DDR5', size: 16, modules: '2 × 8GB',  speed: 6000, cl: 30, voltage: 1.35, shortage: true, spec: '2×8GB · 6000MT/s · CL30' },
    { id: 'ram-ddr5-32-6000', name: 'G.Skill Trident Z5 32GB DDR5-6000',price: 199, mem: 'DDR5', size: 32, modules: '2 × 16GB', speed: 6000, cl: 30, voltage: 1.35, shortage: true, spec: '2×16GB · 6000MT/s · CL30 · sweet spot' },
    { id: 'ram-ddr5-32-6400', name: 'Kingston Fury 32GB DDR5-6400',     price: 219, mem: 'DDR5', size: 32, modules: '2 × 16GB', speed: 6400, cl: 32, voltage: 1.40, shortage: true, spec: '2×16GB · 6400MT/s · CL32' },
    { id: 'ram-ddr5-64-6000', name: 'Corsair Vengeance 64GB DDR5-6000', price: 399, mem: 'DDR5', size: 64, modules: '2 × 32GB', speed: 6000, cl: 30, voltage: 1.35, shortage: true, spec: '2×32GB · 6000MT/s · creators & heavy multitask' },
    { id: 'ram-ddr4-16-3600', name: 'Corsair Vengeance LPX 16GB DDR4',  price: 72,  mem: 'DDR4', size: 16, modules: '2 × 8GB',  speed: 3600, cl: 18, voltage: 1.35, shortage: true, spec: '2×8GB · 3600MT/s · CL18 · scarce, EOL' },
    { id: 'ram-ddr4-32-3600', name: 'G.Skill Ripjaws V 32GB DDR4-3600', price: 129, mem: 'DDR4', size: 32, modules: '2 × 16GB', speed: 3600, cl: 16, voltage: 1.35, shortage: true, spec: '2×16GB · 3600MT/s · CL16 · scarce, EOL' },
  ],

  /* ----------------------------------------------------------- GPUs ---- */
  gpu: [
    { id: 'gpu-rtx4060',   name: 'NVIDIA RTX 4060 8GB',       price: 299, brand: 'NVIDIA', vram: 8,  vramType: 'GDDR6',  bus: 128, boost: 2460, tdp: 115, length: 200, psu_min: 450, power_conn: '1× 8-pin', spec: '1080p high refresh · DLSS 3' },
    { id: 'gpu-rtx4060ti', name: 'NVIDIA RTX 4060 Ti 16GB',   price: 449, brand: 'NVIDIA', vram: 16, vramType: 'GDDR6',  bus: 128, boost: 2535, tdp: 165, length: 245, psu_min: 550, power_conn: '1× 8-pin', spec: '1080p/1440p · 16GB' },
    { id: 'gpu-rtx4070s',  name: 'NVIDIA RTX 4070 Super',     price: 619, brand: 'NVIDIA', vram: 12, vramType: 'GDDR6X', bus: 192, boost: 2475, tdp: 220, length: 280, psu_min: 650, power_conn: '2× 8-pin (or 16-pin)', spec: '1440p ultra · DLSS 3' },
    { id: 'gpu-rtx4070tis',name: 'NVIDIA RTX 4070 Ti Super',  price: 819, brand: 'NVIDIA', vram: 16, vramType: 'GDDR6X', bus: 256, boost: 2610, tdp: 285, length: 305, psu_min: 700, power_conn: '2–3× 8-pin (or 16-pin)', spec: '1440p/4K · 16GB' },
    { id: 'gpu-rtx4080s',  name: 'NVIDIA RTX 4080 Super',     price: 1069,brand: 'NVIDIA', vram: 16, vramType: 'GDDR6X', bus: 256, boost: 2550, tdp: 320, length: 336, psu_min: 750, power_conn: '3× 8-pin (16-pin adapter)', spec: '4K high refresh' },
    { id: 'gpu-rtx4090',   name: 'NVIDIA RTX 4090 24GB',      price: 1899,brand: 'NVIDIA', vram: 24, vramType: 'GDDR6X', bus: 384, boost: 2520, tdp: 450, length: 358, psu_min: 850, power_conn: '16-pin 12VHPWR', spec: '4K no compromise · enormous', img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Asus_Strix_RTX_4090.jpg?width=600' },
    { id: 'gpu-rx7600',    name: 'AMD Radeon RX 7600 8GB',    price: 269, brand: 'AMD',    vram: 8,  vramType: 'GDDR6',  bus: 128, boost: 2655, tdp: 165, length: 204, psu_min: 450, power_conn: '1× 8-pin', spec: '1080p value' },
    { id: 'gpu-rx7800xt',  name: 'AMD Radeon RX 7800 XT',     price: 519, brand: 'AMD',    vram: 16, vramType: 'GDDR6',  bus: 256, boost: 2430, tdp: 263, length: 267, psu_min: 700, power_conn: '2× 8-pin', spec: '1440p ultra · 16GB' },
    { id: 'gpu-rx7900xtx', name: 'AMD Radeon RX 7900 XTX',    price: 949, brand: 'AMD',    vram: 24, vramType: 'GDDR6',  bus: 384, boost: 2500, tdp: 355, length: 287, psu_min: 800, power_conn: '2× 8-pin', spec: '4K · 24GB raster monster', img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Sapphire_AMD_Radeon_RX_7900_XTX.jpg?width=600' },
    { id: 'gpu-arc-b580',  name: 'Intel Arc B580 12GB',       price: 279, brand: 'Intel',  vram: 12, vramType: 'GDDR6',  bus: 192, boost: 2670, tdp: 190, length: 272, psu_min: 500, power_conn: '1× 8-pin', spec: '1440p value · 12GB', img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Intel_Arc_Battlemage_B580_Limited_Edition.jpg?width=600' },
  ],
  ...
  /* ---------------------------------------------------------- Cases ---- */
  case: [
    { id: 'case-o11',    name: 'Lian Li O11 Dynamic EVO',  price: 159, form: 'ATX',      gpu_max: 422, cooler_max: 167, psu_form: 'ATX', radiator: 'Up to 360mm (top/side/bottom)', spec: 'ATX · dual-chamber · glass showcase', img: 'https://commons.wikimedia.org/wiki/Special:FilePath/PC-Geh%C3%A4use_%22Lian_Li_O11_Dynamic_Evo_XL%22_(der8auer-Edition)_20240407_HOF1973_RAW-Export_000167.png?width=600' },
